...
```{r, echo = FALSE, eval = FALSE}
bootstrapStatistic <- function(x, B = 10, seed = 1021, fn = mean, ...) {
...
bs <- bootstrapStatistic(
  dt[num_items_ordered > 5, sales_amount], B = 10, fn = mean
)
...
* Task:
  * Use `experiment_result_HW.csv` or your own project data
