...
- Industry hot topic: [replacing computer vision](https://about.fb.com/news/2021/11/update-on-use-of-face-recognition/)
- Deep Learning dominates: [word2vec](http://mccormickml.com/2016/04/19/word2vec-tutorial-the-skip-gram-model/), [transformers](https://arxiv.org/abs/1706.03762), [BERT](https://arxiv.org/abs/1810.04805), [DALLE](https://openai.com/blog/dall-e/)...
- Some partical applications:
    - Chatbots...
    - Search
    - Translations
    - Text Classification
- These methods still don't understand language!

## About today

- Not going to be about those mentioned before :)
- (But all of them are built on what we'll cover)
- Introduce basic methods to work with text data:
    - Regular expressions
    - Tokenization
    - Sentiment analysis
- Using these for prediction: two weeks from now
...
- So how do you match a literal "."? With escaping! `\. = "dot"`
