...
astra_h_whole_listings <- fread("week 3-4/data/astra_h_ads_20190912_cleaned.csv")
...
# TODO: Number of listings per year
astra_h %>% 
    .[, .N, by = `Évjárat`] %>% 
...
# How to convince your parents to finance your car?
# Show them you are making the right choice.


# First: remove cars that have too high mileage or too costly
# Second: add regression line
# Third: find the one fartest away